...
./save_to_file.sh $HOSTNAME $TIMEZONE $USER $OS $DATE $UPTIME $UPTIME_SEC $IP $MASK $GATEWAY $RAM_TOTAL $RAM_USED $RAM_FREE $SPACE_ROOT $SPACE_ROOT_USED $SPACE_ROOT_FREE